...
export const keysMeta = {
  ...
  CH2MIN1: { path: '/chapters/chapter-2/mining-1' },
  CH2OUT1: { path: '/chapters/chapter-2/outro-1' },

  CH3INT1: { path: 'chapters/chapter-3/intro-1' },
  CH3INT2: { path: 'chapters/chapter-3/intro-2' },
  CH3YVB1: { path: 'chapters/chapter-3/you-vs-bit-1' },
}
